...
export default class OvaNoteScanner extends LightningElement {
    ...
    handleTranscribe() {
        ...
        transcribeNote({ contentDocumentId: this.contentDocumentId })
            .then((text) => {
                ...
                this.statusMessage = 'Transcription ready. Review and save to Visit Notes Dictation below.';
            })
            .catch((error) => {
    ...
    handleFileComment() {
        ...
        saveToVisit({
            ...
            .then(() => {
                this.statusVariant = 'success';
                this.statusMessage = 'Saved to Visit Notes Dictation field. Refresh the page to see the update.';
                this.dispatchEvent(
                    new ShowToastEvent({
                        title: 'Notes saved',
                        message: 'Transcription saved to Visit Notes Dictation field.',
                        variant: 'success'
                    })
                );
                this.transcription = null;
